...
module.exports = {
  async play(song, message, client, filters) {
    ...
    const endembed = new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor(`Music Queue ended. Use ${prefix}p [Title] to play another video / song.\nPlease use ${prefix}leave if you want to stop using Nightcorer!`);
    ...
    let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif";
    else thumb = song.thumbnail.url;

    try {
      let embed = new MessageEmbed()
        .setColor("#F0EAD6")
        .setAuthor(`Started playing: ${song.title}`, 'https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif')
      ...
      switch (reaction.emoji.name) {
        ...
        case "🎵":
          ...
          let nowPlaying = new MessageEmbed()
            .setAuthor('Now playing', 'https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif', 'http://NightcorerMusic.tk')
        ...
        case "📑":
          ...
          let temEmbed = new MessageEmbed()
            .setAuthor("Searching...", "https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif").setFooter("Lyrics")
            .setColor("#F0EAD6")
          let result = await message.channel.send(temEmbed)
          try {
            lyrics = await lyricsFinder(queue.songs[0].title, "");
            if (!lyrics) lyrics = `I haven't found any lyrics for ${queue.songs[0].title}.`;
          } catch (error) {
            lyrics = `I haven't found any lyrics for ${queue.songs[0].title}.`;
          }
