...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    if (!permissions.has("CONNECT"))
      return attentionembed(message, "I dont have permissions to join your channel!");
    if (!permissions.has("SPEAK"))
      return attentionembed(message, "I dont have permissions to speak in your channel");
    ...
    //get the thumbnail
    let thumb = "https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif"
