...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    let temEmbed = new MessageEmbed()
      .setAuthor("Searching...", "https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif")
      .setColor("#F0EAD6")
    ...
    try {
      ...
      if (response === "error") {
        //send error message
        attentionembed(message, "Please use the right emoji.");
