...
module.exports = {
  ...
  execute(message) {
    ...
    if (queue.playing) {
      ...
      .setAuthor(`${message.author.username} paused the music.`, "https://cdn.discordapp.com/attachments/778954384667181076/864948750392098846/Nightcorer-spin-nuovo.gif")
